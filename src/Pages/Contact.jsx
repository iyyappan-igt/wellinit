  ...
  return (
    <section>
      <div className="container-fluid p-0">
        <div className="ct-page position-relative d-md-block d-none">
          ...
          <div className="ct-form position-absolute">
            <div className="container">
              <div className="entry-form" id="letstalk">
                <div className="ct-title text-md-start text-center mb-md-3 mb-3">
        ...
        <div className="row  d-md-none d-block">
          <div className="col-lg-12">
            <div className="ct-page position-relative">
              <div className="ct-img">
                <img src="assets/footer333.png" className="img-fluid" />
              </div>
              <div className="ct-form position-absolute">
                <div className="container">
                  <div className="entry-form" id="letstalk">
          ...
          <div className="ct-img2">
            <img src="assets\footer444.png" className="img-fluid" />
          </div>
          </div>
        </div>
      </div>
