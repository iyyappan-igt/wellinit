    ...
    <section className="athpage">
      ...
      <div className="athena-frame pt-5">
        <div className="container text-center">
          <h4  data-aos="fade-left"  data-aos-duration="1500">{Athena.banner[0]?.sub_title}</h4>
          <h2 data-aos="zoom-in" data-aos-duration="1500" >{Athena.banner[0]?.title}</h2>
          <p  data-aos="fade-right"  data-aos-duration="1500">{Athena.banner[0]?.description}</p>
        </div>
      </div>
      ...
      <div className="modular-service">
        <div className="container">
          <div className="athena-modular" data-aos="fade-left"  data-aos-duration="1500">
          ...
          <div className="ath-module">
            <div className="row">
              <div className="col-lg-5 col-md-6 ">
                ...
                <div className="point-list" data-aos="fade-right"  data-aos-duration="1500">
                ...
                <div className="point-btn mt-xl-5 mt-lg-2 text-md-start text-center" data-aos="fade-right"  data-aos-duration="1500">
              ...
              <div className="col-lg-7 col-md-6">
                <div className="mo-img text-center" >
                  <img src="\assets\obj.png" className="img-fluid" data-aos="zoom-in"  data-aos-duration="1500"/>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="row">
            <div className="col-lg-6 col-md-7">
              <div className="report-content text-center text-md-start">
                <h2 data-aos="fade-left"  data-aos-duration="1500">{Athena.report[0]?.title}</h2>
                <p data-aos="fade-right"  data-aos-duration="1500">{Athena.report[0]?.description}</p>
                <button className="report-btn btn text-white mt-xl-5 mt-lg-2 "data-aos="fade-right"  data-aos-duration="1500">
                  Get Free Consultation
                </button>
              </div>
            </div>
            <div className="col-lg-6 col-md-5">
              <div className="report-img text-center">
                <img src={Athena.report[0]?.image} className="img-fluid"  data-aos="zoom-in"  data-aos-duration="1500"/>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="common-issue value-issue">
        <div className="container">
          <div className="ci-title  text-center">
            <h2 data-aos="zoom-in"  data-aos-duration="1500">{Athena.partner[0]?.title}</h2>
          </div>
